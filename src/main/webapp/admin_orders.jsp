...
<%
AdminOrdersDao orderData = new AdminOrdersDao(DatabaseConnection.getConnetion());
List<Order> order = orderData.getAllOrders();
...
<div class="container">
		<div class="inner">
			<div class="row">
				...
				<div class="col-md-9">
					<h3>Orders Information From Database</h3>
					<table class="table">
						...
						<tbody>
								<c:forEach var="tempUsers" items="${Order_List}">
								<tr>
									<td>${tempUsers.orderId }</td>
									<td>${tempUsers.quantity }</td>
									<td>${tempUsers.date }</td>
								</tr>
